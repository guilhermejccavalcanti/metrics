...
public class JmxReporter implements Reporter, Closeable {
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface MetricMBean {
  ...
  private abstract static class AbstractBean implements MetricMBean {
    ...
    @Override public ObjectName objectName() {
      return objectName;
    }
  }

  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface JmxGaugeMBean extends MetricMBean {
    Object getValue();
  }
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface JmxCounterMBean extends MetricMBean {
    long getCount();
  }
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface JmxHistogramMBean extends MetricMBean {
    long getCount();
  ...
  private static class JmxHistogram implements JmxHistogramMBean {
    ...
    @Override public double get50thPercentile() {
    ...
    @Override public double get75thPercentile() {
      return metric.getSnapshot().get75thPercentile();
    }

    @Override public double get95thPercentile() {
      return metric.getSnapshot().get95thPercentile();
    }

    @Override public double get98thPercentile() {
      return metric.getSnapshot().get98thPercentile();
    }

    @Override public double get99thPercentile() {
      return metric.getSnapshot().get99thPercentile();
    }

    @Override public double get999thPercentile() {
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface JmxMeterMBean extends MetricMBean {
    long getCount();
  ...
  private static class JmxMeter extends AbstractBean implements JmxMeterMBean {
    ...
    @Override public String getRateUnit() {
      return rateUnit;
    }
  ...
  @SuppressWarnings(value = { "UnusedDeclaration" }) public interface JmxTimerMBean extends JmxMeterMBean {
    double getMin();
  ...
  static class JmxTimer extends JmxMeter implements JmxTimerMBean {
    ...
    @Override public String getDurationUnit() {
      return durationUnit;
    }
  }
