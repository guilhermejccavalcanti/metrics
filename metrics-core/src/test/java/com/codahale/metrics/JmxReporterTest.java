...
public class JmxReporterTest {
  ...
  private final JmxReporter reporter = JmxReporter.forRegistry(registry).registerWith(mBeanServer).inDomain(name).convertDurationsTo(TimeUnit.MILLISECONDS).convertRatesTo(TimeUnit.SECONDS).filter(MetricFilter.ALL).build();
  ...
  @Test public void registersMBeansForMetricObjectsUsingProvidedObjectNameFactory() throws Exception {
  ...
  @Test public void registersMBeansForMeters() throws Exception {
  ...
  @Test public void registersMBeansForTimers() throws Exception {
  ...
  @Test public void cleansUpAfterItselfWhenStopped() throws Exception {
    reporter.stop();
    try {
  ...
  @Test public void objectNameModifyingMBeanServer() throws Exception {
